declare module 'react-native-rsa-native' {
	...
	namespace RSA {
		...
		export function encryptPrivate(data: string, privateKey: string): Promise<string>;
		export function decryptPublic(data: string, publicKey: string): Promise<string>;
		//export function encryptPrivate64(data: string, privateKey: string): Promise<string>;
		//export function decryptPublic64(data: string, publicKey: string): Promise<string>;
